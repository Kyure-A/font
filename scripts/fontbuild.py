...
def build(*, version: str) -> fontforge.font:
    font = fontforge.font()
    font.fontname = "kyre-font"
    font.fullname = font.fontname
    font.familyname = font.fontname
    font.copyright = "Copyright (c) 2023 Kyure_A"
    font.weight = "Regular"
    font.os2_weight = 400
